...
import {deposite} from '../../../service/AmountService'
...
const Deposite = () => {
  ...
  const handleSubmit =(values)=>{
    deposite(accountdata._id,values).then(response=>{
    ...
    return (
      <div className="container ">
        <div className=" amountt mx-auto pb-2">
          <div className="mytitle w-100  py-1">
            <div className="mytitleflex mx-2" onClick={() => handleCancel()}>
              <KeyboardBackspaceIcon />
            </div>
         
            <h2 className=" text-center py-2 text-head">DEPOSIT AMOUNT</h2>
          
            <div className='text-center p-0'><PaymentIcon className='profile-icon'/></div>
            </div>
        <form onSubmit={formik.handleSubmit} className='mx-auto my-5 py-3' id='formik-from'>
           ...
           <Row className=" mx-2 my-1 justify-content-center" >
                  ...
                  <button className="btn btn-outline-info w-100  my-2" type="submit">Deposit</button>
                  </Col>
                  <Col lg={2} md={6} sm={12} ml={0} >
